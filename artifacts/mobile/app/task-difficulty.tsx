...
const styles = StyleSheet.create({
  ...
  headerCopy: { flex: 1 },
  title: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 25 },
  subtitle: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 13 },
  reset: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 14 },
  content: { paddingHorizontal: 16, paddingTop: 12, gap: 18 },
  category: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 12, letterSpacing: 1.2, marginBottom: 7, marginLeft: 4 },
  ...
  itemName: { fontFamily: "Inter_600SemiBold", includeFontPadding: false, fontSize: 16 },
  value: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 14 },
  ...
  segmentText: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 13 },
});
