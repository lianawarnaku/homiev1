...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 27 },
  markAll: { minWidth: 56, minHeight: 40, alignItems: "center", justifyContent: "center" },
  markAllText: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 13 },
  content: { padding: 16, gap: 12 },
  proposalGroup: { gap: 12 },
  card: { borderWidth: 1, borderRadius: 18, padding: 15 },
  cardTitle: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 20 },
  meta: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 12, marginTop: 2 },
  assignment: { borderTopWidth: StyleSheet.hairlineWidth, paddingTop: 12, marginTop: 12 },
  member: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 16 },
  taskRow: { flexDirection: "row", alignItems: "center", gap: 9, marginTop: 9 },
  task: { fontFamily: "Inter_600SemiBold", includeFontPadding: false, fontSize: 14 },
  request: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 11 },
  primary: { height: 52, borderRadius: 14, alignItems: "center", justifyContent: "center" },
  primaryText: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 16 },
  override: { height: 50, borderRadius: 14, borderWidth: 1.5, alignItems: "center", justifyContent: "center" },
  overrideText: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 15 },
  empty: { borderWidth: 1, borderRadius: 18, padding: 28, alignItems: "center" },
  emptyTitle: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 19, marginTop: 8 },
  nudgeCard: {
    borderWidth: 1,
    borderRadius: 18,
    padding: 14,
  ...
  alertMessage: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 13, lineHeight: 18, marginTop: 3 },
  nudgeTitle: { fontFamily: "Inter_600SemiBold", includeFontPadding: false, fontSize: 14, lineHeight: 20 },
  dismiss: {
    width: 38,
    height: 38,
    borderRadius: 19,
