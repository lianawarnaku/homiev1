...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 13, fontFamily: "Inter_400Regular", includeFontPadding: false },
  ...
  progressLabel: { fontFamily: "Inter_600SemiBold", includeFontPadding: false, fontSize: 14, flexShrink: 1, paddingRight: 4 },
  progressCount: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 13, flexShrink: 0 },
  progressTrack: {
    height: 6,
    borderRadius: 3,
    overflow: "hidden",
  ...
  choreTitle: { fontFamily: "Inter_500Medium", includeFontPadding: false, fontSize: 15 },
  choreMeta: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 2 },
  dueDateText: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 12 },
  pointsBadge: {
    paddingHorizontal: 8,
    paddingVertical: 3,
    borderRadius: 10,
