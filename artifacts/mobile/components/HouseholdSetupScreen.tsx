...
const styles = StyleSheet.create({
  ...
  itemSections: { gap: 14 }, itemSection: { borderBottomWidth: 1, paddingBottom: 14, gap: 12 }, itemSectionHeader: { flexDirection: "row", alignItems: "center", gap: 9 }, itemSectionIcon: { width: 34, height: 34, borderRadius: 10, alignItems: "center", justifyContent: "center" }, itemSectionTitle: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 20 },
  reviewList: { gap: 8 },
  reviewRow: { minHeight: 58, borderWidth: 1, borderRadius: 13, padding: 11, flexDirection: "row", alignItems: "center", gap: 8 },
  reviewMeta: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 12, marginTop: 3 },
  ...
  decisionTitle: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 21, textAlign: "center" },
  decisionBody: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 14, lineHeight: 20, textAlign: "center", marginBottom: 4 },
