...
const styles = StyleSheet.create({
  ...
  description: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 14, lineHeight: 19 },
  code: {
    borderRadius: 14,
    paddingVertical: 15,
  ...
  primaryText: { color: "#fff", fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 14 },
  secondaryText: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 14 },
  stateRow: { minHeight: 70, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 10 },
  stateText: { fontFamily: "Inter_400Regular", includeFontPadding: false, fontSize: 14 },
  ...
  retryText: { fontFamily: "Inter_700Bold", includeFontPadding: false, fontSize: 14 },
  status: { textAlign: "center", fontFamily: "Inter_600SemiBold", includeFontPadding: false, fontSize: 13 },
});
